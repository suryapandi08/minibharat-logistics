...
// import image from "@/assets/blog-img/5.png";
...
//            Mini Bharat Is Expanding Across India —
//           </h1>
    ...
    <div className="bg-white text-gray-800">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-200">
            Huge territory opportunities are now open for logistics entrepreneurs
            across the country.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-md p-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">
              Mini Bharat Is Expanding Across India — Huge Territory Opportunities
            </h3>
            ...
            <div className="space-y-4 leading-relaxed text-gray-700">
              <p>
                Mini Bharat Logistics is rapidly expanding its footprint across
                India, creating massive opportunities for entrepreneurs to own
                and manage exclusive logistics territories. With the surge in
                e-commerce and last-mile delivery demand, logistics has become
                one of the fastest-growing sectors in the country.
              </p>

              <p>
                As part of its national expansion strategy, Mini Bharat is
                onboarding territory partners in metro cities, tier-2 cities,
                and emerging towns. Each territory partner gets operational
                control, recurring revenue, and long-term growth potential.
              </p>

              <p>
                Unlike traditional franchises, Mini Bharat offers a structured
                logistics ecosystem with centralized technology, operations
                support, and established courier tie-ups. This allows partners
                to focus on scaling volumes rather than worrying about backend
                complexities.
              </p>

              <p>
                Territory owners benefit from daily parcel movement, consistent
                cash flow, and increasing demand from local sellers, warehouses,
                and online marketplaces. As the territory grows, so does the
                earning potential.
              </p>

              <p>
                Mini Bharat’s expansion model is designed to be low risk and
                highly scalable. Partners can start with limited resources and
                gradually expand delivery zones, manpower, and parcel capacity.
              </p>

              <p>
                With strong brand backing, operational training, and ongoing
                support, Mini Bharat empowers entrepreneurs to build a stable,
                future-ready logistics business in their chosen location.
              </p>

              <p>
                Now is the right time to secure your territory. As India’s
                logistics demand continues to rise, early movers stand to gain
                the most from long-term growth and market leadership.
              </p>
            </div>

            {/* Territory Highlights Table */}
            <div className="mt-8 overflow-x-auto">
              <table className="w-full border border-gray-300 rounded-lg text-sm md:text-base">
                <thead className="bg-gray-100">
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td className="py-2 px-3 border-b">Exclusive Area Rights</td>
                  ...
                  <tr className="font-semibold text-green-600 bg-gray-100">
                    <td className="py-2 px-3">Long-Term Growth</td>
                    <td className="py-2 px-3">
                      Strong ROI & business stability
                    </td>
                  </tr>
                </tbody>
              </table>
