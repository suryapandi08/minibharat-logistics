  ...
  const footerSections = [
    {
      title: "Services",
      links: [
        { name: "Last Mile Business Model", path: "/last-mile-business-model" },
        { name: "First Mile Business Model", path: "/first-mile-business-model" },
        { name: "Own Warehouse Business Model", path: "/own-warehouse-business-model" },
        { name: "ODH Warehouse Business Model", path: "/odh-business-model" },
        { name: "MDH Warehouse Business Model", path: "/mdh-business-model" },
        { name: "Grocery Warehouse Business Model", path: "/grocery-business-model" },
        { name: "Large Shipment Warehouse Business Model", path: "/large-shipment-warehouse-business-model" },
        { name: "Non Large Warehouse Business Model", path: "/non-large-warehouse-business-model" },
        { name: "5 Mins Delivery Warehouse Business Model", path: "/five-mins-delivery-business-model" }, 
        { name: "Mints Delivery Business Model", path: "/mints-delivery-business-model" }, 
        { name: "Low Value Shipments Business Model", path: "/low-value-shipments-business-model" }, 
      ],
    },
    {
      title: "Company",
